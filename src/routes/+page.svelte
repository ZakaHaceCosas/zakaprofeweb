...
<main>
    ...
    <hr />
    <h2>
        DESCUBRE LOS CANALES &gt;&gt;&gt; <span class="text-sm opacity-75"
            >(¡sí, canales en plural!)</span
        >
    </h2>
    ...
    <div class="flex flex-col gap-2 md:flex-row">
        <section class="flex-1" aria-labelledby="video-section-1">
            ...
            <div class="flex flex-col items-start gap-3 border-2 border-(--fff25) bg-(--blk) p-4">
                ...
                <p>
                    Aquí se muestran dos videos elegidos al azar, puedes pulsarlos para verlos ahora
                    si quieres.
                </p>
    ...
    <details>
        <summary class="cursor-pointer bg-(--blk) p-2 hover:bg-(--blk-hov)"
            >Clic aquí para una descripción más extensa de cada canal, que dudo que te la leas, pero
            en algún lado tenía que ponerla.</summary
        ><br />
        ...
        <div class="flex w-full flex-col gap-2 md:flex-row">
            <div class="flex-1 bg-(--ZakaProfe) p-4">
                <p class="text-white">
                    ...
                    <b>la calidad de producción excepcional</b>, porque ¿para qué grabarme frente a
                    una pizarra con lo cutre que queda eso? Una presentación con ~200 diapositivas
                    de animaciones profesionales hechas a mano (no es broma...) es mucho más visual
                    y se entiende mejor. Me lo tomo tan innecesariamente en serio que si usas el
                    buscador de este sitio para ver videos (o te vas a las listas de reproducción
                    del canal en YouTube) verás que está agrupado por temporadas, las cuales mido
                    precisamente en base a la calidad de producción (cada mejora significativa marca
                    una nueva temporada).<br /><br />Si vas a YouTube ahora, verás que la última
                    subida fue hace muchos meses, lo sé y lo siento. Quienes me conocen en persona
                    también me lo suelen comentar. <u>No</u>, no está abandonado o algo. Pasa que
                    teniendo estudios que no tienen nada que ver, es difícil sacar tiempo o incluso
                    encontrar la teoría (porque los libros de la ESO no se encuentran tan
                    fácilmente). Tengo una pila de videos incompletos que nunca pude subir y de
                    ideas que no llegué a empezar, y cuando sea el momento llegarán. Prometido. Al
                    menos tienes esta web, esto sí que se actualiza frecuentemente.
                </p>
            </div>
            <div class="flex-1 bg-(--ZakaTeka) p-4">
                <p class="text-black">
                    ...
                    informática, es mi pasión y, aunque esté mal que yo lo diga, se me da bastante
                    bien (solo observa la pedazo de página web profesional que estás viendo para un
                    canal que ni 100 seguidores tiene...). Me encanta enseñar este tipo de cosas,
                    sobre todo porque a cualquiera, vaya a trabajar de ello o no, le viene bien
                    tener algo de cultura tecnológica en el mundo en el que vivimos (y no me vengas
                    con que la IA va a reemplazar todo eso, que te digo yo que no).<br /><br /><b
                        >Este canal tiene videos para cualquier grado de informática (SMR, DAW, DAM
                        o ASIR)</b
                    >, cosa que se dice muy rápido porque casi no tiene videos. Al estudiar yo mismo
                    un grado de estos (SMR concretamente) estoy falto de tiempo y no he podido hacer
                    tantos como quería cuando empecé a estudiar esto, pero llegarán las vacaciones y
                    puedes esperarte entonces muchísimo contenido.<br /><br />En este canal no están
                    esas «animaciones excepcionales» de ZakaProfe, la producción la hago con otro
                    programa y es más sencilla (aunque estoy mejorando aquí también), me centro más
                    en que se entienda y sea fácil de ver.
                </p>
            </div>
        </div>
    </details>
