...
<main>
    ...
    <br />
    <p>
        Aquí están listadas todas las actualizaciones que he ido haciendo a la web. Útil ya que al
        ser menos costoso que hacer videos me la paso haciéndole mejoras todo el rato, que puede que
        no notes si no te las señalo ;)
    </p>
    <hr />
    ...
    <ul>
        ...
        <li>
            Cambiada la tipografía a Roboto (Flex y Mono), que es la tipografía oficial de
            ZakaProfe. Además, se ve mejor.
        </li>
    ...
    <ul>
        <li>
            Ahora la web no se desplegará con cada confirmación que se sube al repositorio, por lo
            que el repositorio refleja ahora el futuro de la página y no el estado actual.
        </li>
    </ul>
    <hr />
    ...
    <ul>
        ...
        <li>
            Eliminada la lógica inútil de las traducciones, reduciendo así consumo y trabajo de
            carga.
        </li>
    </ul>
    <hr />
    ...
    <ul>
        ...
        <li>
            Ahora el contador de palabras también mide el tiempo de lectura (de forma muy
            aproximada).
        </li>
    ...
    <ul>
        ...
        <li>
            Actualizadas las imágenes de escritorio en el instalador de la Aplicación Web
            Progresiva.
        </li>
    ...
    <ul>
        ...
        <li>
            Ahora hay que presionar el footer para ver el texto de derechos de autor; así se ve
            mejor en móvil y molesta menos.
        </li>
    </ul>
    <hr />
    ...
    <ul>
        <li>
            Se cambiaron ligeramente los estilos (ahora son sin degradados + se arregló el overlay
            de los videos en móvil + otros ajustes menores).
        </li>
    ...
    <ul>
        ...
        <li>
            La página «Estudia más» fue ocultada por completo. El código aún existe, pero es ahora
            100% inaccesible y dicho código ya no está en el repositorio.
        </li>
    </ul>
    <h3>Actualizaciones internas (desarrollo):</h3>
    <ul>
    ...
    <ul>
        ...
        <li>
            La página «Estudia más» ahora está sin usar y no está referenciada. Aún existe y su
            pathname ha sido cambiado a <code>/estudia</code>.
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            Establecido <code>pnpm</code> como el gestor de paquetes predeterminado del proyecto.
        </li>
        <li>
    ...
    <ul>
        ...
        <li>
            Cambiado <em>Coming soon</em> por <em>Pronto disponible</em>, ya que la web está en
            español.
        </li>
