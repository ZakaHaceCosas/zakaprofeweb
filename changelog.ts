...
const newFooterLines = [
    ...
    `<p class="text-end"><b>ZakaProfe WEB v${ver}</b> · <a href="/changelog" class="underline">¿Qué hay de nuevo en esta versión?</a></p>`,
    ...footerFileLines.slice(footerLineStartIdx + 4),
];
