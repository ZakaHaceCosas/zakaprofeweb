<script lang="ts">
    ...
    import Textarea from "@zpw/ui/Textarea";
...
<p>
    ...
    interesará saber para entregar trabajos.<br /><br />Este contador mide palabras, caracteres, y
    párrafos por ti. Solo pega aquí tu texto (o empieza a escribir) y baja abajo del todo, se
    muestra al instante sin ningún clic.<br /><br />
</p>
...
{#if text.trim() !== ""}
    ...
    <ul>
        ...
        <li>
            <b>{text.split("\n").length}</b> párrafos usando un solo salto de línea (recuerda usar dos)
        </li>
        <li>
